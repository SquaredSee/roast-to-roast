    ...
    const array = [
      ...
      { //FRENCH PRESS
        expanded: false, categoryName: 'French Press', subCategory: [
          { id: 1, text: <Text style={styles.subCategoryText}>Total Time: ~5 minutes</Text>},
          { id: 2, text: <Text style={styles.subCategoryText}>Directions:</Text> },
          { id: 3, text: <Text style={styles.subCategoryBody}>
      ...
      { //CHEMEX
        expanded: false, categoryName: 'Chemex', subCategory: [
          { id: 1, text: <Text style={styles.subCategoryText}>Total Time: ~4 minutes</Text>},
          { id: 2, text: <Text style={styles.subCategoryText}>Directions:</Text>},
          { id: 3, text: <Text style={styles.subCategoryBody}>
      ...
      { //KALITA WAVE
        expanded: false, categoryName: 'Kalita Wave', subCategory: [
          { id: 1, text: <Text style={styles.subCategoryText}>Total Time: ~3 minutes</Text>},
          { id: 2, text: <Text style={styles.subCategoryText}>Directions:</Text>},
          { id: 3, text: <Text style={styles.subCategoryBody}>
      ...
      { //SYPHON
        expanded: false, categoryName: 'Syphon', subCategory: [
          { id: 1, text: <Text style={styles.subCategoryText}>Total Time: ~6 minutes</Text>},
          { id: 2, text: <Text style={styles.subCategoryText}>Directions:</Text>},
          { id: 3, text: <Text style={styles.subCategoryBody}>
      ...
      { //COLD BREW
        expanded: false, categoryName: 'Cold Brew', subCategory: [
          { id: 1, text: <Text style={styles.subCategoryText}>Total Time: 8-12 hours</Text>},
          { id: 2, text: <Text style={styles.subCategoryText}>Directions:</Text>},
          { id: 3, text: <Text style={styles.subCategoryBody}>
      ...
      { // ESPRESSO MACHINE
        expanded: false, categoryName: 'Espresso Machine', subCategory: [
          { id: 1, text: <Text style={styles.subCategoryText}>Total Time: ~2 minutes</Text>},
          { id: 2, text: <Text style={styles.subCategoryText}>Directions:</Text>},
          { id: 3, text: <Text style={styles.subCategoryBody}>
      ...
      { //MOKA POT
        expanded: false, categoryName: 'Moka Pot', subCategory: [
          { id: 2, text: <Text style={styles.subCategoryText}>Total Time: ~6 minutes</Text>},
          { id: 2, text: <Text style={styles.subCategoryText}>Directions:</Text>},
          { id: 3, text: <Text style={styles.subCategoryBody}>
