    ...
    const array = [
      ...
      { //FRENCH PRESS
        expanded: false, categoryName: 'French Press', subCategory: [
          { id: 1, text: 'Total Time: 5 minutes' },
          { id: 2, text: 'Directions:' },
          { id: 3,
            body: true,
            text: (
      ...
      { //CHEMEX
        expanded: false, categoryName: 'Chemex', subCategory: [
          { id: 1, text: 'Total Time: 4 minutes' },
          { id: 2, text: 'Directions:' },
          { id: 3,
            body: true,
            text: (
      ...
      { //KALITA WAVE
        expanded: false, categoryName: 'Kalita Wave', subCategory: [
          { id: 1, text: 'Total Time: 3 minutes' },
          { id: 2, text: 'Directions:' },
          { id: 3,
            body: true,
            text: (
      ...
      { //SYPHON
        expanded: false, categoryName: 'Syphon', subCategory: [
          { id: 1, text: 'Total Time: 6 minutes' },
          { id: 2, text: 'Directions:' },
          { id: 3,
            body: true,
            text: (
      ...
      { //COLD BREW
        expanded: false, categoryName: 'Cold Brew', subCategory: [
          { id: 1, text: 'Total Time: 8-12 hours' },
          { id: 2, text: 'Directions:' },
          { id: 3,
            body: true,
            text: (
      ...
      { // ESPRESSO MACHINE
        expanded: false, categoryName: 'Espresso Machine', subCategory: [
          { id: 1, text: 'Total Time: 2 minutes' },
          { id: 2, text: 'Directions:' },
          { id: 3,
            body: true,
            text: (
